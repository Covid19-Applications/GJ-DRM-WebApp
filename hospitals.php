...
.bradcam_area p a:hover {
  color: #fff;
    ...
    <!-- bradcam_area_start  -->
    <div class="bradcam_area breadcam_bg_1 " style="background-image: url(img/gujarat/hospital.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
	...
	<div class="whole-wrap">
		<div class="container box_1170">
			...
			<div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Hospitals In Gujarat</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <?php
                                                  $query = "SELECT * FROM hospitals WHERE state = 'gujarat'";
