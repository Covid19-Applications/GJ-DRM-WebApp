 ...
 <div class="main-content" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Gujarat Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Gujarat Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Gujarat Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Cases In Gujarat</h2>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Gujarat</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                      ...
                                      <div class="au-card chart-percent-card" style="height: 580px;" id="testing">
                                        <div class="au-card-inner">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=1xn1DjDIpkwfoWXIVyquBE0rOP0EW95Un" width="100%" height="380"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
...
$.ajax({
    ...
    var conf_rate = (((StateConfirmed)*100)/(21988238));
...
$.ajax({
   ...
   console.log(covid_data_zone.zones);
    ...
    //console.log(Green.length); 
    var Greenlength = Math.round((Green.length/33)*100);
    document.getElementById("Greenzone-per").innerHTML = Greenlength;
     ...
     var Redlength = Math.round((Red.length/33)*100);
    document.getElementById("Redzone-per").innerHTML = Redlength;
    ...
    var Orangelength =  Math.round((Orange.length/33)*100);
    document.getElementById("Orangezone-per").innerHTML = Orangelength;
